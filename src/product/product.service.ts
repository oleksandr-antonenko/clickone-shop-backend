...
export class ProductService {
  ...
  async createProductFromRequest(req: FastifyRequest): Promise<Product> {
    ...
    const productDto = this.transformFormDataToDto(formData);
    
    return this.createProducts(productDto, file);
  }
  ...
  private transformFormDataToDto(formData: Record<string, any>): CreateProductDto {
    return {
      name: formData.name,
  ...
  async createProducts(createProductDto: CreateProductDto, file?: any) {
